...
let currentTheme = localStorage.getItem('theme') || 'light'; // "light", "dark", "purple"
...
function filterTransactions() {
    ...
    if (filteredTransactions.length === 0) showNotification('Транзакции в этот период времени отсутствуют');
    renderTransactions(filteredTransactions);
    updateCharts();
    updateTotalBalances();
}
